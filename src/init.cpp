 ...
 * between bitcoind, and btw-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bootstrap", _("Enables Bitcoin World bootstrap mode. Allows BTW client to connect to Bitcoin p2p network to download blockahin history."));
