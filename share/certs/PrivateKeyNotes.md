...
allowing somebody to distribute a Bitcoin-Qt.app or btw-qt-setup.exe with a valid
...
that the btw-qt.exe file inside the installer had not been tampered with.
